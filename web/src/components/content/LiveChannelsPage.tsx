      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground">
            Please add a playlist to view live channels.
          </p>
        </div>
      </div>
    );
    ...
    <>
      <div className="bg-background min-h-screen px-8 py-10 lg:px-12 lg:py-12">
        <div className="space-y-12 lg:space-y-16">
          <ContentHeader
            title="Live TV"
            description="Watch your cached live channels"
            iconButtons={[
              {
                icon: <Search className="h-6 w-6" />,
                onClick: () => setSearchOpen(true),
                label: "Search live channels",
                variant: "outline",
              },
            ]}
          />
      ...
      <SearchDialog open={searchOpen} onOpenChange={setSearchOpen} sourceId={sourceId} />
    </>
  );
}
