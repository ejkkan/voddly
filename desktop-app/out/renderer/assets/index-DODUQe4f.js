...
const appIcon = "" + new URL("icon-CGaRmsny.png", import.meta.url).href;
const TitlebarContext = reactExports.createContext(void 0);
const TitlebarContextProvider = ({ children }) => {
  const [activeMenuIndex, setActiveMenuIndex] = reactExports.useState(null);
  const [menusVisible, setMenusVisible] = reactExports.useState(false);
...
const useTitlebarContext = () => {
  const context = reactExports.useContext(TitlebarContext);
  if (!context) {
...
const TitlebarMenu = () => {
  const { menuItems: menuItems2 } = useWindowContext().titlebar;
  if (!menuItems2) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "window-titlebar-menu", children: menuItems2.map((menu, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarMenuItem, { menu, index }, index)) });
};
const TitlebarMenuItem = ({ menu, index }) => {
  ...
  reactExports.useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (menuItemRef.current && !menuItemRef.current.contains(target) && menuItemRef.current.classList.contains("active")) {
        setActiveMenuIndex(null);
      }
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-menuItem", ref: menuItemRef, children: [
    ...
    activeMenuIndex === index && /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarMenuPopup, { menu })
  ] });
};
const TitlebarMenuPopup = ({ menu }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "menuItem-popup", children: menu.items.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarMenuPopupItem, { item }, index)) });
const TitlebarMenuPopupItem = ({ item }) => {
  ...
  if (item.name === "---") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "menuItem-popupItem menuItem-separator" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "menuItem-popupItem", onClick: handleAction, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: item.name }),
    item.shortcut && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "menuItem-shortcut", children: item.shortcut })
  ] });
};
const SVG_PATHS = {
...
const Titlebar = () => {
  const { title, icon, titleCentered, menuItems: menuItems2 } = useWindowContext().titlebar;
  const { menusVisible, setMenusVisible, closeActiveMenu } = useTitlebarContext();
  const { window: wcontext } = useWindowContext();
  reactExports.useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.altKey && menuItems2?.length && !e.repeat) {
  ...
  }, [menusVisible, closeActiveMenu, setMenusVisible, menuItems2]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `window-titlebar ${wcontext?.platform ? `platform-${wcontext.platform}` : ""}`, children: [
    wcontext?.platform === "win32" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "window-titlebar-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: icon }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    menusVisible && /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarMenu, {}),
    wcontext?.platform === "win32" && /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarControls, {})
  ] });
};
const TitlebarControls = () => {
  const { window: wcontext } = useWindowContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "window-titlebar-controls", children: [
    wcontext?.minimizable && /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarControlButton, { label: "minimize", svgPath: SVG_PATHS.minimize }),
    wcontext?.maximizable && /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarControlButton, { label: "maximize", svgPath: SVG_PATHS.maximize }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarControlButton, { label: "close", svgPath: SVG_PATHS.close })
  ] });
};
const TitlebarControlButton = ({ svgPath, label }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-label": label, className: "titlebar-controlButton", onClick: handleAction, children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "10", height: "10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "currentColor", d: svgPath }) }) });
};
const WindowContext = reactExports.createContext(void 0);
const WindowContextProvider = ({
  ...
  const [initProps, setInitProps] = reactExports.useState();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(WindowContext.Provider, { value: { titlebar, window: initProps }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TitlebarContextProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Titlebar, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "window-content", children })
  ] });
};
const useWindowContext = () => {
  const context = reactExports.useContext(WindowContext);
  if (!context) {
...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.hasError) {
      return this.props.fallback || /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md w-full space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-destructive/10 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-foreground", children: "Something went wrong" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "An unexpected error occurred in the application. Please try refreshing the page or contact support if the problem persists." })
          ] }),
          this.state.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "cursor-pointer list-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "hover:bg-accent border-border/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 p-4 bg-muted/50 rounded-lg border border-border/50 text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Error Message" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "mt-1 text-sm text-foreground bg-background p-2 rounded border border-border/50 overflow-x-auto", children: this.state.error.message })
              ] }),
              this.state.error.stack && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Stack Trace" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "mt-1 text-xs text-muted-foreground bg-background p-2 rounded border border-border/50 overflow-x-auto max-h-32", children: this.state.error.stack })
              ] })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => window.location.reload(), className: "flex-1", size: "lg", children: [
...
const EraShape = ({ onPathHover, onPathReset, ...props }) => {
  const [hoveredPath, setHoveredPath] = reactExports.useState("ERA");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "voddly-shape", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.span,
      {
        ...
        children: hoveredPath
      },
      hoveredPath
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "100%", height: "100%", viewBox: "0 0 195 197", xmlns: "http://www.w3.org/2000/svg", ...props, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "viteGradient", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#68a9fd", stopOpacity: "1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#b244fb", stopOpacity: "1" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
...
const ContentStep = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-content-step", children: [
...
const EraContent = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "learn-more", children: [
      "Learn more about Electron React App at",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/guasam/voddly", target: "_blank", rel: "noreferrer", children: "github.com" })
    ] })
  ] });
};
const ElectronContent = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "flex items-center gap-4", children: [
      "Electron",
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded-md bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "res://icons/electron.png", className: "w-4 h-4" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "With the power of modern Chromium, Electron gives you an unopinionated blank slate to build your app." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Choose to integrate your favourite libraries and frameworks from the front-end ecosystem, or carve your own path with bespoke HTML code." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-content-steps", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ContentStep,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "learn-more", children: [
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.electronjs.org/", target: "_blank", rel: "noreferrer", children: "electronjs.org" })
    ] })
  ] });
};
const ReactContent = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "flex items-center gap-4", children: [
      "React",
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded-md bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "res://icons/react.png", className: "w-4 h-4" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "React is a declarative, efficient, and flexible JavaScript library for building user interfaces." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "It lets you build user interfaces out of individual pieces called components, creating reusable and maintainable code for your applications." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-content-steps", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ContentStep,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "learn-more", children: [
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://reactjs.org/", target: "_blank", rel: "noreferrer", children: "reactjs.org" })
    ] })
  ] });
};
const ViteContent = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "flex items-center gap-4", children: [
      "Electron Vite",
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded-md bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "res://icons/vite.png", className: "w-4 h-4" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Combine Electron's desktop capabilities with Vite's lightning-fast development experience." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "This powerful combination delivers exceptional developer experience with instant HMR, while allowing you to build feature-rich desktop applications." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-content-steps", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ContentStep,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "learn-more", children: [
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://electron-vite.org/guide/", target: "_blank", rel: "noreferrer", children: "electron-vite.org" })
    ] })
  ] });
};
const ShadContent = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "flex items-center gap-4", children: [
      "Shadcn UI",
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded-md bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "res://icons/shadcn.png", className: "w-4 h-4" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A collection of re-usable components built with Radix UI and Tailwind CSS." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Shadcn UI provides a set of accessible, customizable, and beautiful components that you can copy and paste into your apps. It's not a component library, but a collection of re-usable components that you can copy and customize." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-content-steps", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ContentStep,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "learn-more", children: [
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://ui.shadcn.com/", target: "_blank", rel: "noreferrer", children: "ui.shadcn.com" })
    ] })
  ] });
};
const TailwindContent = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "flex items-center gap-4", children: [
      "Tailwind CSS",
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1 rounded-md bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "res://icons/tailwind.png", className: "w-4 h-4" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A utility-first CSS framework for rapidly building custom user interfaces." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Tailwind CSS provides low-level utility classes that let you build completely custom designs without ever leaving your HTML, resulting in faster development and cleaner code." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-content-steps", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ContentStep,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "learn-more", children: [
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://tailwindcss.com/", target: "_blank", rel: "noreferrer", children: "tailwindcss.com" })
    ] })
  ] });
};
function WelcomeKit() {
  const [activePath, setActivePath] = reactExports.useState(5);
  ...
  const content = () => {
    switch (activePath) {
      case 0:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ElectronContent, {});
      case 1:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ReactContent, {});
      case 2:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ViteContent, {});
      case 3:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ShadContent, {});
      case 4:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TailwindContent, {});
      case 5:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(EraContent, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(EraContent, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-content flex flex-col gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(EraShape, { onPathHover: handlePathHover, onPathReset: handlePathReset })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center items-center gap-4 opacity-50 hover:opacity-80 transition-opacity", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DarkModeToggle, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FullscreenBrowserButton, {})
    ] })
  ] });
}
const DarkModeToggle = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center gap-2 text-sm cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", onClick: toggleDarkMode, children: isDarkMode ? "Dark Mode" : "Light Mode" }) });
};
const FullscreenBrowserButton = () => {
  const handleOpenFullscreenBrowser = () => {
    if (window.conveyor) {
      window.conveyor.window.webOpenFullscreenBrowser("http://localhost:8081");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center gap-2 text-sm cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleOpenFullscreenBrowser, variant: "secondary", size: "sm", children: "Open localhost:8081" }) });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WelcomeKit, {});
}
ReactDOM.createRoot(document.getElementById("app")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(WindowContextProvider, { titlebar: { title: "Electron React App", icon: appIcon, menuItems }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }) })
);
