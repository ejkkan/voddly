...
const slides = [
  {
    ...
    subtitle: 'iOS Experience',
    description: 'Beautiful iOS-native experience',
    icon: '🍎',
  },
  {
    id: '2',
    ...
    description: 'High quality streaming on iPhone/iPad',
    icon: '📡',
  },
  {
    id: '3',
    ...
    description: 'Enjoy on the go',
    icon: '🎬',
  },
];

export default function OnboardingIOS() {
