...
export const positionExamples = {
  ...
  bottom: () => notify.error('Bottom position', { position: ToastPosition.BOTTOM }),
...
export const actionToastExamples = {
  dismissable: () => notify.success('Action completed!', {
    action: {
      label: 'Dismiss',
  ...
  withCustomAction: () => notify.info('New message received', {
    action: {
      label: 'View',
  ...
  errorWithRetry: () => notify.error('Failed to load data', {
    action: {
      label: 'Retry',
...
export const advancedExamples = {
  ...
  withDescription: () => notify.info('Update available', {
...
export const commonScenarios = {
  ...
  // User actions
  userAction: () => notify.info('Action completed', {
    action: {
      label: 'Undo',
  ...
  // Notifications
  notification: () => notify.info('New notification', {
